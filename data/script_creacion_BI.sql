...
INSERT INTO BI_LOS_HEREDEROS_DE_MONTIEL_Y_EL_DATO_PERSISTIDO.BI_HECHO_ANUNCIO(anuncio_id, tipo_operacion_id, ambientes_id, tiempo_id, fecha_alta_id, fecha_baja_id)
SELECT 
    an.codigo,
    op.id, 
    dim_amb.id, 
