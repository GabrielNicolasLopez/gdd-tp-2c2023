...
/*
-- Cambiamos a unique key
ALTER TABLE LOS_HEREDEROS_DE_MONTIEL_Y_EL_DATO_PERSISTIDO.INMUEBLE
    ADD CONSTRAINT FK_INMUEBLE_PROPIETARIO_ID FOREIGN KEY (propietario_id) REFERENCES LOS_HEREDEROS_DE_MONTIEL_Y_EL_DATO_PERSISTIDO.PROPIETARIO (persona_id)
GO
*/
...
/*
ALTER TABLE LOS_HEREDEROS_DE_MONTIEL_Y_EL_DATO_PERSISTIDO.VENTA
    ADD CONSTRAINT FK_VENTA_COMPRADOR_ID FOREIGN KEY (comprador_id) REFERENCES LOS_HEREDEROS_DE_MONTIEL_Y_EL_DATO_PERSISTIDO.COMPRADOR (persona_id)
GO
*/
...
/*
ALTER TABLE LOS_HEREDEROS_DE_MONTIEL_Y_EL_DATO_PERSISTIDO.ALQUILER
    ADD CONSTRAINT FK_ALQUILER_INQUILINO_ID FOREIGN KEY (inquilino_id) REFERENCES LOS_HEREDEROS_DE_MONTIEL_Y_EL_DATO_PERSISTIDO.INQUILINO (persona_id)
GO
*/
...
ALTER TABLE LOS_HEREDEROS_DE_MONTIEL_Y_EL_DATO_PERSISTIDO.ALQUILER
    ADD CONSTRAINT FK_ALQUILER_ESTADO_ID FOREIGN KEY (estado_id) REFERENCES LOS_HEREDEROS_DE_MONTIEL_Y_EL_DATO_PERSISTIDO.ESTADO_ALQUILER (id)
GO
...
/*
ALTER TABLE LOS_HEREDEROS_DE_MONTIEL_Y_EL_DATO_PERSISTIDO.COMPRADOR
    ADD CONSTRAINT FK_COMPRADOR_CODIGO_VENTA FOREIGN KEY (codigo_venta) REFERENCES LOS_HEREDEROS_DE_MONTIEL_Y_EL_DATO_PERSISTIDO.VENTA (codigo)
GO
*/
...
ALTER TABLE LOS_HEREDEROS_DE_MONTIEL_Y_EL_DATO_PERSISTIDO.INQUILINO
    ADD CONSTRAINT FK_INQUILINO_CODIGO_ALQUILER FOREIGN KEY (codigo_alquiler) REFERENCES LOS_HEREDEROS_DE_MONTIEL_Y_EL_DATO_PERSISTIDO.ALQUILER (codigo)
GO
...
ALTER TABLE LOS_HEREDEROS_DE_MONTIEL_Y_EL_DATO_PERSISTIDO.PROPIETARIO
    ADD CONSTRAINT FK_PROPIETARIO_INMUEBLE_ID FOREIGN KEY (inmueble_id) REFERENCES LOS_HEREDEROS_DE_MONTIEL_Y_EL_DATO_PERSISTIDO.INMUEBLE (codigo)
GO
-- Fin crear FKs
...
AS
BEGIN
    INSERT INTO LOS_HEREDEROS_DE_MONTIEL_Y_EL_DATO_PERSISTIDO.SUCURSAL(direccion, localidad_id, nombre, telefono)
    SELECT DISTINCT GD_ESQUEMA.MAESTRA.SUCURSAL_DIRECCION,
                    l.id,
                    GD_ESQUEMA.MAESTRA.SUCURSAL_NOMBRE,
                    GD_ESQUEMA.MAESTRA.SUCURSAL_TELEFONO
    FROM GD_ESQUEMA.MAESTRA
             JOIN LOS_HEREDEROS_DE_MONTIEL_Y_EL_DATO_PERSISTIDO.LOCALIDAD l
