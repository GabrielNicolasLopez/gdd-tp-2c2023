...
ALTER TABLE LOS_HEREDEROS_DE_MONTIEL_Y_EL_DATO_PERSISTIDO.VENTA
    ADD CONSTRAINT FK_VENTA_ANUNCIO_ID FOREIGN KEY (anuncio_id) REFERENCES LOS_HEREDEROS_DE_MONTIEL_Y_EL_DATO_PERSISTIDO.LOCALIDAD (codigo)
GO
...
ALTER TABLE LOS_HEREDEROS_DE_MONTIEL_Y_EL_DATO_PERSISTIDO.ALQUILER
    ADD CONSTRAINT FK_ALQUILER_ANUNCIO_ID FOREIGN KEY (anuncio_id) REFERENCES LOS_HEREDEROS_DE_MONTIEL_Y_EL_DATO_PERSISTIDO.LOCALIDAD (codigo)
GO
...
ALTER TABLE LOS_HEREDEROS_DE_MONTIEL_Y_EL_DATO_PERSISTIDO.COMPRADOR
    ADD CONSTRAINT FK_COMPRADOR_CODIGO_VENTA FOREIGN KEY (codigo_venta) REFERENCES LOS_HEREDEROS_DE_MONTIEL_Y_EL_DATO_PERSISTIDO.LOCALIDAD (codigo)
GO
...
ALTER TABLE LOS_HEREDEROS_DE_MONTIEL_Y_EL_DATO_PERSISTIDO.INQUILINO
    ADD CONSTRAINT FK_INQUILINO_CODIGO_ALQUILER FOREIGN KEY (codigo_alquiler) REFERENCES LOS_HEREDEROS_DE_MONTIEL_Y_EL_DATO_PERSISTIDO.LOCALIDAD (codigo)
GO
...
ALTER TABLE LOS_HEREDEROS_DE_MONTIEL_Y_EL_DATO_PERSISTIDO.PROPIETARIO
    ADD CONSTRAINT FK_PROPIETARIO_INMUEBLE_ID FOREIGN KEY (inmueble_id) REFERENCES LOS_HEREDEROS_DE_MONTIEL_Y_EL_DATO_PERSISTIDO.LOCALIDAD (codigo)
GO
-- Fin crear FKs
