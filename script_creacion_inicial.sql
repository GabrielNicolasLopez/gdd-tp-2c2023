...
IF OBJECT_ID('LOS_HEREDEROS_DE_MONTIEL_Y_EL_DATO_PERSISTIDO.MICRAR_AGENTE') IS NOT NULL
    DROP PROCEDURE LOS_HEREDEROS_DE_MONTIEL_Y_EL_DATO_PERSISTIDO.MICRAR_AGENTE
GO
...
--TODO Persona ya se encuentra migrada más abajo (validar si es correcto la forma de migrar)
